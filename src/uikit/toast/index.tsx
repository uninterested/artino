...
class Toast {
    ...
    /** 构造对象 */
    private static create(icon: TImageProps, message: TMessageProps, duration: number, cb?: () => void) {
     ...
     * @param duration 时长
     */
    public static info(message: TMessageProps, duration: number = 2, cb?: () => void) {
     ...
     * @param duration 时长
     */
    public static success(message: TMessageProps, duration: number = 2, cb?: () => void) {
     ...
     * @param duration 时长
     */
    public static failed(message: TMessageProps, duration: number = 2, cb?: () => void) {
     ...
     * @param duration 时长
     */
    public static loading(message: TMessageProps, duration: number = 2, cb?: () => void) {
     ...
     * @param cb 
     */
    public static text(message: TMessageProps, duration: number = 2, cb?: () => void) {
     ...
     * @param duration 时长
     */
    public static show(message: TMessageProps, icon?: TImageProps, duration: number = 2, cb?: () => void) {
